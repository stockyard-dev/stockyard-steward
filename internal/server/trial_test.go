...
// newTestDB is a local helper since steward has no existing test file
// that defines one.
func newTestDB(t *testing.T) *store.DB {
	t.Helper()
	dir, err := os.MkdirTemp("", "steward-trial-test-*")
	if err != nil {
